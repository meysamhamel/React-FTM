  ...
  render() {
    const _this$props = this.props,
      ...
      tooltipPlacement
          ...
          other = _objectWithoutPropertiesLoose(_this$props, ["ButtonProps", "classes", "className", "delay", "icon", "id", "onClick", "onKeyDown", "open", "tooltipTitle", "tooltipPlacement", "tooltipOpen"]);
